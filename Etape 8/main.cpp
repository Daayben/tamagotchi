...
void jouerTamagotchi()
{
    ...
    std::cout << "Voulez-vous charger un Tamagotchi sauvegardé (o/n) ? ";
    std::cin >> choixUtilisateur;

    Tamagotchi tamagotchi("Temp"); // Création temporaire, sera écrasé
    ...
    else
    {
        ...
        std::cin >> nomTamagotchi;
        tamagotchi = Tamagotchi(nomTamagotchi);
    }
    tamagotchi.setCheminSauvegarde("sauvegarde.txt");
