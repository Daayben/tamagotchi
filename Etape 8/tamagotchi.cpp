...
void GestionnaireSauvegarde::sauvegarderTamagotchi(Tamagotchi &tamagotchi)
{
    std::ofstream fichier("sauvegarde.txt");
    if (fichier.is_open())
    {
        fichier << tamagotchi.getNom() << std::endl;
        fichier << tamagotchi.getFaim() << std::endl;
        fichier << tamagotchi.getBonheur() << std::endl;
        fichier << tamagotchi.getSante() << std::endl;
        fichier << tamagotchi.getAge() << std::endl;
        fichier.close();
    }
    else
    {
...
Tamagotchi GestionnaireSauvegarde::chargerTamagotchi()
{
    std::ifstream fichier("sauvegarde.txt");
    std::string nom;
    int faim, bonheur, sante, age;
    fichier >> nom >> faim >> bonheur >> sante >> age;
    Tamagotchi tamagotchi(nom);
    tamagotchi.setFaim(faim);
    tamagotchi.setBonheur(bonheur);
    tamagotchi.setSante(sante);
